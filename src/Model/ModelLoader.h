...
struct Importer {
	...
	static bool importTexture2D(const aka::String& name, const aka::Path& path);
	// Import a cubemap and add it to resource manager
	static bool importTextureCubemap(const aka::String& name, const aka::Path& px, const aka::Path& py, const aka::Path& pz, const aka::Path& nx, const aka::Path& ny, const aka::Path& nz);
	// Import an envmap, convert it to cubemap and add it to resource manager
	static bool importTextureEnvmap(const aka::String& name, const aka::Path& path);
